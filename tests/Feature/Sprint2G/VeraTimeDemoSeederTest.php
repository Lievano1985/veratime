...
it('runs the Vera Time demo seeder and creates expected Sprint 2 data', function (): void {
    ...
    expect($company->name)->toBe('Vera Time Demo Completo')
        ...
        ->and($company->workers()->count())->toBe(3)
        ->and($company->employmentRelationships()->count())->toBe(3)
        ->and($company->laborConditions()->count())->toBe(3)
        ->and($company->workerCredentials()->count())->toBe(3)
        ...
        ->and($company->mandatoryRestDays()->count())->toBe(2)
