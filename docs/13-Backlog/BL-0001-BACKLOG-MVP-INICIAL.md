...
| F. Calendario diario y publicacion | Crear batches obligatorios por centro y daily schedules publicados | D/E | `schedule_batches`, `daily_schedule_assignments`, `daily_schedule_segments` | publicacion no destructiva | F1/F2 implementados/candidatos a cierre: nucleo diario y generacion draft desde perfiles; interfaz/publicacion operativa pendientes | Versionado incorrecto | 6 |
