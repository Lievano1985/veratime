...
| E. Perfiles cycle, flexible y on_call | Agregar ciclos, ventanas/minutos y disponibilidad bajo demanda | D | cycle rules, flexible rules, on_call rules | dominio y resolucion | E1 implementado/candidato a cierre: dominio cycle/flexible/on_call disponible sin UI; E2 pendiente | Complejidad UX | 5 |
