...
return new class extends Migration
{
    ...
    {
        Schema::create('schedule_profile_on_call_rules', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['schedule_profile_id', 'day_of_week'], 'schedule_profile_on_call_day_unique');
            $table->index(['company_id', 'schedule_profile_id'], 'schedule_profile_on_call_company_profile_idx');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('schedule_profile_on_call_rules');
    }
};
