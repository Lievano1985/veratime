...
<div class="relative">
    ...
    <div class="mt-[6px] flex h-10 w-full rounded-lg shadow-xs -space-x-px" role="group">
        <input
            ...
            autocomplete="off"
            {{ $attributes->class([
                'h-10 min-w-0 flex-1 rounded-s-lg border border-zinc-200 border-b-zinc-300/80 bg-white px-3 py-2 text-base leading-[1.375rem] text-zinc-700 placeholder-zinc-400 focus:z-10 focus:border-zinc-400 focus:outline-none sm:text-sm dark:border-white/10 dark:bg-white/10 dark:text-zinc-300 dark:placeholder-zinc-400',
            ]) }}
        >
